...
function addServer(&$servers, $name, $urlTemplate, $imdbId, $movieId, $type = 'iframe') {
    ...
    } elseif (strpos($urlTemplate, '{tmdb}') !== false) {
        if ($movieId > 0) {
...
// ===== SERVER UTAMA: api.codespecters.com =====
addServer($servers, 'CodeSpecters HD', 'https://api.codespecters.com/embed/movie/{imdb}?code=nx_0e614ede5c5cefcf40c76b9351c0f727', $imdbId, $movieId);
addServer($servers, 'CodeSpecters Pro', 'https://api.codespecters.com/v2/embed/movie/{imdb}?code=nx_0e614ede5c5cefcf40c76b9351c0f727', $imdbId, $movieId);
addServer($servers, 'CodeSpecters Stream', 'https://api.codespecters.com/stream/movie/{imdb}?code=nx_0e614ede5c5cefcf40c76b9351c0f727', $imdbId, $movieId);
addServer($servers, 'CodeSpecters Backup', 'https://api.codespecters.com/backup/embed/movie/{imdb}?code=nx_0e614ede5c5cefcf40c76b9351c0f727', $imdbId, $movieId);
addServer($servers, 'CodeSpecters Alt', 'https://api.codespecters.com/alternate/movie/{imdb}?code=nx_0e614ede5c5cefcf40c76b9351c0f727', $imdbId, $movieId);
